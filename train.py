...
def get_arguments(raw_args):
    ...
    parser.add_argument('--num_trains',default=200, type=int, help="Number of train records. Set None to use all")
    ...
    parser.add_argument('--train_val_removal',default='keep_all', choices=["keep_all", "keep_list", "keep_junction", "reservoir", "tank"], type=str, help="simple-keep_all, tough-keep_list. Node removal strategy to remove different nodal types in the water network. Support: keep_list| reservoir| tank| keep_junction| keep_all")
